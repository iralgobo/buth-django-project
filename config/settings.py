...
SECRET_KEY = 'django-insecure-%vtj^*(@u)%_ub1!ln+o$&#1)4v^a-f5!*imje66*m**yo@o61'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", default="buth"),
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to Buth",

    # Copyright on the footer
    "copyright": "Acme Buth Ltd",
